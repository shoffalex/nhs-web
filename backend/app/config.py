...
class Settings(BaseSettings):
    ...
    # In production this points at /var/lib/nhs-web/calendar.db — never at a path
    # inside the repo, or a deploy would overwrite live data.
    ...
    # different port than the API. In production nginx puts both on one origin.
